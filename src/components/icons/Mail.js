  ...
  return (
    ...
    >
      ...
      <g id='SVGRepo_iconCarrier'>
        <g id='style=stroke'>
          <g id='email'>
            {/* Outer box and path for the envelope shape */}
            <path
              id='vector (Stroke)'
              fillRule='evenodd'
              clipRule='evenodd'
              ...
              fill='#545454' // Hardcoded fill color
            ></path>
            {/* Inner path for the letter M in the envelope */}
            <path
              id='vector (Stroke)_2'
              fillRule='evenodd'
              clipRule='evenodd'
              ...
              fill='#545454' // Hardcoded fill color for the envelope
            ></path>
          </g>
        </g>
      </g>
...
// Wrap the Mail icon inside a generic Icon component
const WrappedMail = () => (
  <Icon email={true}>
    <Mail />
  </Icon>
...
export default React.memo(WrappedMail);
